  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-100">
      ...
      <main className="flex flex-1 items-center justify-center px-4 py-12">
        <div className="w-full max-w-4xl overflow-hidden rounded-lg border border-slate-200 bg-white md:grid md:grid-cols-12">
          {/* Left Clinical Information Panel */}
          <div className="hidden flex-col justify-between bg-slate-900 p-10 text-white md:col-span-5 md:flex">
            <div>
              <div className="mb-4 inline-flex items-center gap-2 rounded-lg border border-blue-700/60 bg-blue-900/40 px-3 py-1.5 text-sm font-semibold text-blue-300">
                <ShieldCheck className="h-4 w-4" />
                Clinical Account Registration
              </div>
              <h1 className="text-2xl font-bold tracking-tight text-white">Join the ArthroCare clinical workspace</h1>
              ...
              <div className="mt-8 space-y-4 border-t border-slate-800 pt-6 text-sm text-slate-300">
            ...
            <div className="border-t border-slate-800 pt-6 text-xs font-medium text-slate-500">
          ...
          <div className="p-8 sm:p-10 md:col-span-7">
            <h2 className="text-xl font-bold tracking-tight text-slate-900">Create patient account</h2>
            <p className="mt-2 text-sm text-slate-500">Enter patient details to register your clinical workspace account.</p>
